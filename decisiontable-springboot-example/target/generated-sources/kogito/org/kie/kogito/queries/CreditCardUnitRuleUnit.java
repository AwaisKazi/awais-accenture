...
public class CreditCardUnitRuleUnit extends AbstractRuleUnit<CreditCardUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @org.springframework.beans.factory.annotation.Autowired()
    public CreditCardUnitRuleUnit(org.kie.kogito.Application app) {
        super(CreditCardUnit.class.getCanonicalName(), app);
    }

    public org.kie.kogito.queries.CreditCardUnitRuleUnitInstance internalCreateInstance(CreditCardUnit value) {
        return new org.kie.kogito.queries.CreditCardUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.kie.kogito.queries.RulesF894883E1030542FEFCE9860F835B9B7_CreditCardUnit(), ruleBaseConfig);
        return kb;
    }
}
