...
@RestController
@RequestMapping("/find-credit-card-approved")
public class CreditCardUnitQueryFindCreditCardApprovedEndpoint {

    @Autowired
    RuleUnit<org.kie.kogito.queries.CreditCardUnit> ruleUnit;

    public CreditCardUnitQueryFindCreditCardApprovedEndpoint() {
    }

    public CreditCardUnitQueryFindCreditCardApprovedEndpoint(RuleUnit<org.kie.kogito.queries.CreditCardUnit> ruleUnit) {
    ...
    public List<org.kie.kogito.queries.CreditCardApplication> executeQuery(@RequestBody(required = true) org.kie.kogito.queries.CreditCardUnit unitDTO) {
        ...
        List<org.kie.kogito.queries.CreditCardApplication> response = instance.executeQuery(CreditCardUnitQueryFindCreditCardApproved.class);
        instance.dispose();
        return response;
    }
