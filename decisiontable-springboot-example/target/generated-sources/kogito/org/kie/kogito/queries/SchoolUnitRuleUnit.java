...
public class SchoolUnitRuleUnit extends AbstractRuleUnit<SchoolUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @org.springframework.beans.factory.annotation.Autowired()
    public SchoolUnitRuleUnit(org.kie.kogito.Application app) {
        super(SchoolUnit.class.getCanonicalName(), app);
    }

    public org.kie.kogito.queries.SchoolUnitRuleUnitInstance internalCreateInstance(SchoolUnit value) {
        return new org.kie.kogito.queries.SchoolUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.kie.kogito.queries.RulesF894883E1030542FEFCE9860F835B9B7_SchoolUnit(), ruleBaseConfig);
        return kb;
    }
}
