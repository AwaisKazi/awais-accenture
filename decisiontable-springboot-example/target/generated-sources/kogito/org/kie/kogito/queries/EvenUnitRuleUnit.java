...
public class EvenUnitRuleUnit extends AbstractRuleUnit<EvenUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @org.springframework.beans.factory.annotation.Autowired()
    public EvenUnitRuleUnit(org.kie.kogito.Application app) {
        super(EvenUnit.class.getCanonicalName(), app);
    }

    public org.kie.kogito.queries.EvenUnitRuleUnitInstance internalCreateInstance(EvenUnit value) {
        return new org.kie.kogito.queries.EvenUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.kie.kogito.queries.RulesF894883E1030542FEFCE9860F835B9B7_EvenUnit(), ruleBaseConfig);
        return kb;
    }
}
