...
public class StudentUnitRuleUnit extends AbstractRuleUnit<StudentUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @org.springframework.beans.factory.annotation.Autowired()
    public StudentUnitRuleUnit(org.kie.kogito.Application app) {
        super(StudentUnit.class.getCanonicalName(), app);
    }

    public org.kie.kogito.queries.StudentUnitRuleUnitInstance internalCreateInstance(StudentUnit value) {
        return new org.kie.kogito.queries.StudentUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.kie.kogito.queries.RulesF894883E1030542FEFCE9860F835B9B7_StudentUnit(), ruleBaseConfig);
        return kb;
    }
}
