...
@RestController
@RequestMapping("/find-credit-approved")
public class CreditCardUnitQueryFindCreditApprovedEndpoint {

    @Autowired
    RuleUnit<org.kie.kogito.queries.CreditCardUnit> ruleUnit;

    public CreditCardUnitQueryFindCreditApprovedEndpoint() {
    }

    public CreditCardUnitQueryFindCreditApprovedEndpoint(RuleUnit<org.kie.kogito.queries.CreditCardUnit> ruleUnit) {
    ...
    public List<org.kie.kogito.queries.CreditCardApplication> executeQuery(@RequestBody(required = true) org.kie.kogito.queries.CreditCardUnit unitDTO) {
        ...
        List<org.kie.kogito.queries.CreditCardApplication> response = instance.executeQuery(CreditCardUnitQueryFindCreditApproved.class);
        instance.dispose();
        return response;
    }
